...
export default function LoginPageRecruteur() {
    ...
    <main className="w-full h-screen flex flex-col items-center px-4">
      <div className="max-w-sm w-full text-gray-600 space-y-5">
        <div className="text-center p-5">
          <img src="/logo/logo-recruteur.png" width={375} height={75} alt="Logo" />
        </div>
        {/* <div className="mt-5">
          <h3 className="text-gray-800 text-2xl font-bold sm:text-2xl">Espace Recruteur</h3>
        </div> */}
