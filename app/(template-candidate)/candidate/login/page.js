    ...
    <main className="w-full h-screen flex flex-col items-center px-4">
      <div className="max-w-sm w-full text-gray-600 space-y-5">
        <div className="text-center p-5">
          <img src="/logo/logo-candidate.png" width={375} height={75} alt="Logo" />
        </div>
      
       {/*  <div className="mt-5">
          <h3 className="text-gray-800 text-2xl font-bold sm:text-2xl">Espace Candidate</h3>
        </div> */}
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <SubmitButton
        isLoading={isLoading} // ou true si en chargement
      ...
      />
        ...
        <p className="text-center">Vous n'avez pas de compte ?
          <a role="button" onClick={handRegister} className="font-medium text-indigo-600 hover:text-indigo-500 mx-3">Créer compte</a>
        </p>
      </div>
    </main>
  );
